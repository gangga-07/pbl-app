    ...
    <div class="intro-x dropdown w-8 h-8">
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                {{-- KALO DIA SEBAGAI ADMIN MAKA MENU INI YANG MUNCUL --}}
                @if (Auth::user()->role_id == 1)
                <li class="p-2">
                    <div class="font-medium">{{ auth()->user()->name ??'Username'}}</div>
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500 capitalize">{{auth()->user()->level??'Admin'}}
                    </div>
                </li>
                <li>
                ...
                {{-- KALO DIA USER MAKAN MENU INI SAJA YANG MUNCUL --}}
                @else
                <li class="p-2">
                    <div class="font-medium">{{ auth()->user()->name ??'Username'}}</div>
                ...
                <li>
                    <a href="{{route ('update-password')}}"  class="dropdown-item hover:bg-white/5"> <i data-lucide="lock"
