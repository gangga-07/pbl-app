                    ...
                    <div
                        ...
                        <form action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                                <button type="submit"
                                    class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Send Reset
                                </button>
                                <a href={{route('login')}}
                                class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Back</a>
                            </div>
